...
function qe(e, {c: t = 1, offset: r = 0, attachPx: o = !0} = {}) {
    if (typeof e == "number") {
        const n = (e + r) * t;
        return n === 0 ? "0" : `${n}px`
    } else if (typeof e == "string") if (_l.test(e)) {
...
function El(e = {}, t) {
    const r = Ha({ctrl: !1, command: !1, win: !1, shift: !1, tab: !1}), {keydown: o, keyup: n} = e, i = a => {
        switch (a.key) {
            case"Control":
                r.ctrl = !0;
                break;
...
const Al = Ge("n-internal-select-menu-body"), Ln = "__disabled__";

function Ct(e) {
    const t = ue(Ar, null), r = ue(Dr, null), o = ue(tr, null), n = ue(Al, null), i = O();
...
Ct.tdkey = Ln;
Ct.propTo = {type: [String, Object, Boolean], default: void 0};
let tt = null;
...
function fr(e) {
    const t = e.getBoundingClientRect(), r = En();
    return {
        left: t.left - r.left,
        top: t.top - r.top,
...
const Nl = q({
        ...
        setup(e) {
            ...
            const r = ue("VBinder", null), o = O(null), n = x => {
        ...
        mounted(e, {value: t}) {
            e[pt] = {handler: void 0}, typeof t == "function" && (e[pt].handler = t, Oe("mousemoveoutside", e, t))
        }, updated(e, {value: t}) {
            const r = e[pt];
    ...
    }, jl = Hl, {c: Ht} = Va(), Ul = "vueuc-style", jt = {top: "bottom", bottom: "top", left: "right", right: "left"},
    Ro = {start: "end", center: "center", end: "start"},
    hr = {top: "height", bottom: "height", left: "width", right: "width"}, Wl = {
        ...
        "left-start": "bottom",
        "left-end": "top"
    }, Mo = {top: !0, bottom: !1, left: !0, right: !1}, Oo = {top: "end", bottom: "start", left: "end", right: "start"};

function ql(e, t, r, o, n, i) {
    if (!n || i) return {placement: e, top: 0, left: 0};
    const [l, d] = e.split("-");
    let a = d ?? "center", s = {top: 0, left: 0};
    const u = (p, v, y) => {
        let w = 0, x = 0;
        const P = r[p] - t[v] - t[p];
        return P > 0 && o && (y ? x = Mo[v] ? P : -P : w = Mo[v] ? P : -P), {left: w, top: x}
    }, f = l === "left" || l === "right";
    if (a !== "center") {
        const p = Kl[e], v = jt[p], y = hr[p];
        if (r[y] > t[y]) {
            if (t[p] + t[y] < r[y]) {
                const w = (r[y] - t[y]) / 2;
        ...
        const p = l === "bottom" || l === "top" ? "left" : "top", v = jt[p], y = hr[p], w = (r[y] - t[y]) / 2;
...
const Yl = Ht([Ht(".v-binder-follower-container", {
        ...
        pointerEvents: "none",
        zIndex: "auto"
    }), Ht(".v-binder-follower-content", {position: "absolute", zIndex: "auto"}, [Ht("> *", {pointerEvents: "all"})])]),
    Nn = q({
        name: "Follower",
        inheritAttrs: !1,
        props: {
        ...
        setup(e) {
            const t = ue("VBinder"), r = We(() => e.enabled !== void 0 ? e.enabled : e.show), o = O(null), n = O(null),
                i = () => {
            ...
            const d = Ka();
            Yl.mount({id: "vueuc/binder", head: !0, anchorMetaName: Ul, ssr: d}), nt(() => {
                l()
            }), Bl(() => {
                r.value && a()
            });
            const a = () => {
                ...
                const h = o.value;
                if (h === null) return;
                const p = t.targetRef, {x: v, y, overlap: w} = e, x = v !== void 0 && y !== void 0 ? Dl(v, y) : fr(p);
                ...
                const A = fr(h), $ = fr(n.value), {left: _, top: K, placement: F} = ql(b, x, A, m, R, w),
                    M = Gl(F, w), {left: C, top: T, transform: H} = Xl(F, $, x, K, _, w);
            ...
            return {VBinder: t, mergedEnabled: r, offsetContainerRef: n, followerRef: o, mergedTo: f, syncPosition: a}
        },
        render() {
            return c(vn, {show: this.show, to: this.mergedTo, disabled: this.teleportDisabled}, {
                default: () => {
                    var e, t;
                    const r = c("div", {
                    ...
                    return this.zindexable ? xt(r, [[Hr, {enabled: this.mergedEnabled, zIndex: this.zIndex}]]) : r
                }
            })
        }
    });
...
const ys = bs;
var ws = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, xs = "\\u0300-\\u036f", Cs = "\\ufe20-\\ufe2f",
    Ss = "\\u20d0-\\u20ff", ks = xs + Cs + Ss, Ps = "[" + ks + "]", $s = RegExp(Ps, "g");
...
var Un = "\\ud800-\\udfff", Ms = "\\u0300-\\u036f", Os = "\\ufe20-\\ufe2f", Bs = "\\u20d0-\\u20ff", Ls = Ms + Os + Bs,
    Wn = "\\u2700-\\u27bf", Vn = "a-z\\xdf-\\xf6\\xf8-\\xff", Es = "\\xac\\xb1\\xd7\\xf7",
    As = "\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf", Ds = "\\u2000-\\u206f",
    Fs = " \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000",
    Kn = "A-Z\\xc0-\\xd6\\xd8-\\xde", Ns = "\\ufe0e\\ufe0f", qn = Es + As + Ds + Fs, Gn = "['’]", Bo = "[" + qn + "]",
    Hs = "[" + Ls + "]", Xn = "\\d+", js = "[" + Wn + "]", Yn = "[" + Vn + "]",
    Zn = "[^" + Un + qn + Xn + Wn + Vn + Kn + "]", Us = "\\ud83c[\\udffb-\\udfff]", Ws = "(?:" + Hs + "|" + Us + ")",
    Vs = "[^" + Un + "]", Jn = "(?:\\ud83c[\\udde6-\\uddff]){2}", Qn = "[\\ud800-\\udbff][\\udc00-\\udfff]",
    gt = "[" + Kn + "]", Ks = "\\u200d", Lo = "(?:" + Yn + "|" + Zn + ")", qs = "(?:" + gt + "|" + Zn + ")",
    Eo = "(?:" + Gn + "(?:d|ll|m|re|s|t|ve))?", Ao = "(?:" + Gn + "(?:D|LL|M|RE|S|T|VE))?", ei = Ws + "?",
    ti = "[" + Ns + "]?", Gs = "(?:" + Ks + "(?:" + [Vs, Jn, Qn].join("|") + ")" + ti + ei + ")*",
    Xs = "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", Ys = "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])",
    Zs = ti + ei + Gs, Js = "(?:" + [js, Jn, Qn].join("|") + ")" + Zs,
...
var ld = Object.prototype, sd = ld.propertyIsEnumerable, Do = Object.getOwnPropertySymbols, dd = Do ? function (e) {
...
var pd = rr(or, "Set");
const Rr = pd;
var No = "[object Map]", vd = "[object Object]", Ho = "[object Promise]", jo = "[object Set]", Uo = "[object WeakMap]",
    Wo = "[object DataView]", gd = St(Ir), md = St(Pr), bd = St(_r), yd = St(Rr), wd = St(Tr), ct = mn;
(Ir && ct(new Ir(new ArrayBuffer(1))) != Wo || Pr && ct(new Pr) != No || _r && ct(_r.resolve()) != Ho || Rr && ct(new Rr) != jo || Tr && ct(new Tr) != Uo) && (ct = function (e) {
    var t = mn(e), r = t == vd ? e.constructor : void 0, o = r ? St(r) : "";
    if (o) switch (o) {
        case gd:
            return Wo;
        case md:
...
function kd(e, t) {
    for (var r = -1, o = e == null ? 0 : e.length; ++r < o;) if (t(e[r], r, e)) return !0;
    return !1
}
...
var _d = 1, Rd = 2, Md = "[object Boolean]", Od = "[object Date]", Bd = "[object Error]", Ld = "[object Map]",
    Ed = "[object Number]", Ad = "[object RegExp]", Dd = "[object Set]", Fd = "[object String]", Nd = "[object Symbol]",
    Hd = "[object ArrayBuffer]", jd = "[object DataView]", Ko = mo ? mo.prototype : void 0,
...
var Wd = 1, Vd = Object.prototype, Kd = Vd.hasOwnProperty;

function qd(e, t, r, o, n, i) {
    var l = r & Wd, d = Fo(e), a = d.length, s = Fo(t), u = s.length;
    if (a != u && !l) return !1;
    for (var f = a; f--;) {
        var h = d[f];
...
var Gd = 1, qo = "[object Arguments]", Go = "[object Array]", Ut = "[object Object]", Xd = Object.prototype,
    Xo = Xd.hasOwnProperty;

function Yd(e, t, r, o, n, i) {
    var l = rt(e), d = rt(t), a = l ? Go : Vo(e), s = d ? Go : Vo(t);
    a = a == qo ? Ut : a, s = s == qo ? Ut : s;
    var u = a == Ut, f = s == Ut, h = a == s;
    if (h && yo(e)) {
        if (!yo(t)) return !1;
        l = !0, u = !1
    }
    ...
    if (!(r & Gd)) {
        var p = u && Xo.call(e, "__wrapped__"), v = f && Xo.call(t, "__wrapped__");
        if (p || v) {
            var y = p ? e.value() : e, w = v ? t.value() : t;
...
function vr(e) {
    return function () {
        var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
            r = t.width ? String(t.width) : e.defaultWidth, o = e.formats[r] || e.formats[e.defaultWidth];
        return o
    }
}
...
function _t(e) {
    return function (t, r) {
        ...
        if (o === "formatting" && e.formattingValues) {
            var i = e.defaultFormattingWidth || e.defaultWidth, l = r != null && r.width ? String(r.width) : i;
            n = e.formattingValues[l] || e.formattingValues[i]
        } else {
            var d = e.defaultWidth, a = r != null && r.width ? String(r.width) : e.defaultWidth;
...
function Rt(e) {
    return function (t) {
        var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, o = r.width,
            n = o && e.matchPatterns[o] || e.matchPatterns[e.defaultMatchWidth], i = t.match(n);
        if (!i) return null;
        var l = i[0], d = o && e.parsePatterns[o] || e.parsePatterns[e.defaultParseWidth],
...
function kc(e) {
    return function (t) {
        var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, o = t.match(e.matchPattern);
        if (!o) return null;
        var n = o[0], i = t.match(e.parsePattern);
        if (!i) return null;
...
const zc = $c;
var Tc = {full: "EEEE, MMMM do, y", long: "MMMM do, y", medium: "MMM d, y", short: "MM/dd/yyyy"},
    Ic = {full: "h:mm:ss a zzzz", long: "h:mm:ss a z", medium: "h:mm:ss a", short: "h:mm a"}, _c = {
        full: "{{date}} 'at' {{time}}",
        long: "{{date}} 'at' {{time}}",
        medium: "{{date}}, {{time}}",
        short: "{{date}}, {{time}}"
    }, Rc = {
        date: vr({formats: Tc, defaultWidth: "full"}),
        time: vr({formats: Ic, defaultWidth: "full"}),
        dateTime: vr({formats: _c, defaultWidth: "full"})
    };
const Mc = Rc;
var Oc = {
...
const Lc = Bc;
var Ec = {narrow: ["B", "A"], abbreviated: ["BC", "AD"], wide: ["Before Christ", "Anno Domini"]}, Ac = {
    narrow: ["1", "2", "3", "4"],
    ...
    ordinalNumber: jc,
    era: _t({values: Ec, defaultWidth: "wide"}),
    quarter: _t({
        values: Ac, defaultWidth: "wide", argumentCallback: function (t) {
            return t - 1
        }
    }),
    month: _t({values: Dc, defaultWidth: "wide"}),
    day: _t({values: Fc, defaultWidth: "wide"}),
    dayPeriod: _t({values: Nc, defaultWidth: "wide", formattingValues: Hc, defaultFormattingWidth: "wide"})
};
const Wc = Uc;
var Vc = /^(\d+)(th|st|nd|rd)?/i, Kc = /\d+/i, qc = {
        narrow: /^(b|a)/i,
        abbreviated: /^(b\.?\s?c\.?|b\.?\s?c\.?\s?e\.?|a\.?\s?d\.?|c\.?\s?e\.?)/i,
        wide: /^(before christ|before common era|anno domini|common era)/i
    }, Gc = {any: [/^b/i, /^(a|c)/i]},
    Xc = {narrow: /^[1234]/i, abbreviated: /^q[1234]/i, wide: /^[1234](th|st|nd|rd)? quarter/i},
    Yc = {any: [/1/i, /2/i, /3/i, /4/i]}, Zc = {
        narrow: /^[jfmasond]/i,
        ...
        ordinalNumber: kc({
            matchPattern: Vc, parsePattern: Kc, valueCallback: function (t) {
                return parseInt(t, 10)
            }
        }),
        era: Rt({matchPatterns: qc, defaultMatchWidth: "wide", parsePatterns: Gc, defaultParseWidth: "any"}),
        quarter: Rt({
            matchPatterns: Xc,
        ...
        month: Rt({matchPatterns: Zc, defaultMatchWidth: "wide", parsePatterns: Jc, defaultParseWidth: "any"}),
        day: Rt({matchPatterns: Qc, defaultMatchWidth: "wide", parsePatterns: eu, defaultParseWidth: "any"}),
        dayPeriod: Rt({matchPatterns: tu, defaultMatchWidth: "any", parsePatterns: ru, defaultParseWidth: "any"})
    };
const nu = ou;
var iu = {
    code: "en-US",
...
const au = iu, lu = {name: "en-US", locale: au}, su = lu;

function ro(e) {
    const {mergedLocaleRef: t, mergedDateLocaleRef: r} = ue(bn, null) || {}, o = D(() => {
        var i, l;
...
const du = q({
    ...
    yu = Xe("retry", c("svg", {
        ...
        name: "ResizeSmall", render() {
            return c("svg", {
                xmlns: "http://www.w3.org/2000/svg",
                viewBox: "0 0 20 20"
            }, c("g", {fill: "none"}, c("path", {
...
function Pu(e, t = {}) {
    const {preserveGroup: r = !1} = t, o = [], n = r ? l => {
...
function Fu(e, t, r, o) {
    const n = Qt(t, r, o, !1), i = Qt(e, r, o, !0), l = Du(e, r), d = [];
    return n.forEach(a => {
...
function br(e, t) {
    ...
    } : n !== void 0 ? {checkedKeys: Bu(r, n), indeterminateKeys: Array.from(i)} : {
    ...
    const h = a === "parent", p = a === "child" || d, v = f, y = new Set,
        w = Math.max.apply(null, Array.from(u.keys()));
    for (let x = w; x >= 0; x -= 1) {
        const P = x === 0, k = u.get(x);
        for (const b of k) {
            ...
            for (const _ of b.children) {
                const K = _.key;
                if (!_.disabled) {
                    if ($ && ($ = !1), v.has(K)) A = !0; else if (y.has(K)) {
                        A = !0, z = !1;
                        break
                    } else if (z = !1, A) break
                }
    ...
    return {checkedKeys: Array.from(v), indeterminateKeys: Array.from(y)}
}

function Qt(e, t, r, o) {
    const {treeNodeMap: n, getChildren: i} = t, l = new Set, d = new Set(e);
    return e.forEach(a => {
        const s = n.get(a);
        s !== void 0 && ai(s, u => {
...
function Nu(e, {includeGroup: t = !1, includeSelf: r = !0}, o) {
    ...
    const d = {keyPath: [], treeNodePath: [], treeNode: l};
...
function Zo(e, t, {loop: r = !1, includeDisabled: o = !1} = {}) {
    const n = t === "prev" ? Uu : ju, i = {reverse: t === "prev"};
    let l = !1, d = null;

    function a(s) {
        if (s !== null) {
            if (s === e) {
                if (!l) l = !0; else if (!e.disabled && !e.isGroup) {
                    d = e;
                    return
                }
...
function oo(e, t = {}) {
    ...
    if (o) {
        const {length: n} = o, i = r ? n - 1 : 0, l = r ? -1 : n, d = r ? -1 : 1;
        for (let a = i; a !== l; a += d) {
            const s = o[a];
            if (!s.disabled && !s.ignored) if (s.isGroup) {
                const u = oo(s, t);
                if (u !== null) return u
            } else return s
        }
...
function Gu(e, t = {}) {
    var r;
    const o = new Map, n = new Map, {getDisabled: i = Ru, getIgnored: l = Iu, getIsGroup: d = Lu, getKey: a = Tu} = t,
        s = (r = t.getChildren) !== null && r !== void 0 ? r : zu, u = t.ignoreEmptyChildren ? b => {
            const m = s(b);
...
const Xu = {iconSizeSmall: "34px", iconSizeMedium: "40px", iconSizeLarge: "46px", iconSizeHuge: "52px"}, Yu = e => {
        const {
            textColorDisabled: t,
            iconColor: r,
            textColor2: o,
    ...
    }, Zu = {name: "Empty", common: Be, self: Yu}, Ju = Zu, Qu = S("empty", `
 display: flex;
...
`, [B("icon", `
 ...
 `)]), ef = Object.assign(Object.assign({}, ae.props), {
        ...
        name: "Empty", props: ef, setup(e) {
            const {mergedClsPrefixRef: t, inlineThemeDisabled: r} = Re(e),
                o = ae("Empty", "-empty", Qu, Ju, e, t), {localeRef: n} = ro("Empty"), i = ue(bn, null), l = D(() => {
                    var u, f, h;
                    ...
                    const {size: u} = e, {
                        ...
                        self: {[ie("iconSize", u)]: h, [ie("fontSize", u)]: p, textColor: v, iconColor: y, extraTextColor: w}
                    } = o.value;
                    return {
                        "--n-icon-size": h,
                        "--n-font-size": p,
            ...
            return r == null || r(), c("div", {
                ...
                style: this.cssVars
            }, this.showIcon ? c("div", {class: `${t}-empty__icon`}, e.icon ? e.icon() : c(pe, {clsPrefix: t}, {default: this.mergedRenderIcon})) : null, this.showDescription ? c("div", {class: `${t}-empty__description`}, e.default ? e.default() : this.localizedDescription) : null, e.extra ? c("div", {class: `${t}-empty__extra`}, e.extra()) : null)
        }
    }), tf = {
        space: "6px",
        spaceArrow: "10px",
    ...
    }, of = {name: "Popover", common: Be, self: rf}, io = of,
    yr = {top: "bottom", bottom: "top", left: "right", right: "left"}, Pe = "var(--n-arrow-height) * 1.414",
    nf = L([S("popover", `
 transition:
 ...
 `), ...mc({
        ...
        return e.map(n => {
            const i = n.split("-")[1] === "end", d = `calc((${`var(--v-target-${o}, 0px)`} - ${Pe}) / 2)`, a = Ye(n);
...
}, c("div", {class: `${t}-popover-arrow`, style: e})), af = q({
    name: "PopoverBody", inheritAttrs: !1, props: si, setup(e, {slots: t, attrs: r}) {
        const {namespaceRef: o, mergedClsPrefixRef: n, inlineThemeDisabled: i} = Re(e),
            l = ae("Popover", "-popover", nf, io, e, n), d = O(null), a = ue("NPopover"), s = O(null), u = O(e.show),
            f = O(!1);
        ft(() => {
            const {show: z} = e;
        ...
        const h = D(() => {
            const {trigger: z, onClickoutside: A} = e, $ = [], {positionManuallyRef: {value: _}} = a;
            return _ || (z === "click" && !A && $.push([xo, b, void 0, {capture: !0}]), z === "hover" && $.push([jl, k])), A && $.push([xo, b, void 0, {capture: !0}]), (e.displayDirective === "show" || e.animated && f.value) && $.push([yn, e.show]), $
        }), p = D(() => {
            const z = e.width === "trigger" ? void 0 : qe(e.width), A = [];
            z && A.push({width: z});
            const {maxWidth: $, minWidth: _} = e;
            return $ && A.push({maxWidth: qe($)}), _ && A.push({maxWidth: qe(_)}), i || A.push(v.value), A
        }), v = D(() => {
            const {
                common: {cubicBezierEaseInOut: z, cubicBezierEaseIn: A, cubicBezierEaseOut: $},
                self: {
                    space: _,
                    spaceArrow: K,
                    padding: F,
        ...
        a.setBodyInstance({syncPosition: w}), nt(() => {
        ...
        function R() {
            ...
            let A;
            const $ = a.internalRenderBodyRef.value, {value: _} = n;
            if ($) A = $([`${_}-popover-shared`, y == null ? void 0 : y.themeClass.value, e.overlap && `${_}-popover-shared--overlap`, e.showArrow && `${_}-popover-shared--show-arrow`, e.arrowPointToCenter && `${_}-popover-shared--center-arrow`], s, p.value, x, P); else {
                const {value: K} = a.extraClassRef, {internalTrapFocus: F} = e, M = !So(t.header) || !So(t.footer),
                    C = () => {
                        var T;
                        const H = M ? c(Ve, null, Ze(t.header, re => re ? c("div", {
                                ...
                                class: `${_}-popover__content`,
                                style: e.contentStyle
                            }, t), N = e.scrollable ? c(wn, {
                                contentClass: M ? void 0 : `${_}-popover__content`,
                                contentStyle: M ? void 0 : e.contentStyle
                            }, {default: () => H}) : H,
                            Y = e.showArrow ? di({arrowStyle: e.arrowStyle, clsPrefix: _}) : null;
                        return [N, Y]
                    };
                A = c("div", Lt({
                    ...
                    }], ref: s, style: p.value, onKeydown: a.handleKeydown, onMouseenter: x, onMouseleave: P
                }, r), F ? c(al, {active: e.show, autoFocus: !0}, {default: C}) : C())
            }
            return xt(A, h.value)
        }
        ...
        return c(Nn, {
            ...
            default: () => this.animated ? c(bt, {
                name: "popover-transition", appear: this.isMounted, onEnter: () => {
...
const cf = se("").type, ar = {
        ...
        name: "Popover", inheritAttrs: !1, props: uf, __popover__: !0, setup(e) {
            const t = Nr(), r = O(null), o = D(() => e.show), n = O(e.defaultShow), i = nr(o, n),
                l = We(() => e.disabled ? !1 : i.value), d = () => {
                    if (e.disabled) return !0;
                    const {getDisabled: C} = e;
                    return !!(C != null && C())
                }, a = () => d() ? !1 : i.value, s = Ll(e, ["arrow", "showArrow"]), u = D(() => e.overlap ? !1 : s.value);
            let f = null;
            const h = O(null), p = O(null), v = We(() => e.x !== void 0 && e.y !== void 0);
            ...
            if (!t && (r.activator ? o = ko(r, "activator") : o = ko(r, "trigger"), o)) {
                ...
                }), o.props.internalSyncTargetWithParent = !0, o.props.internalInheritedEventHandlers ? o.props.internalInheritedEventHandlers = [i, ...o.props.internalInheritedEventHandlers] : o.props.internalInheritedEventHandlers = [i]; else {
                    const {internalInheritedEventHandlers: l} = this, d = [i, ...l], a = {
                        onBlur: s => {
                            d.forEach(u => {
                                u.onBlur(s)
                            })
            ...
            return c(Dn, {
                ...
                default: () => {
                    ...
                    return [this.internalTrapFocus && i ? xt(c("div", {
                        ...
                        enabled: i,
                        zIndex: this.zIndex
                    }]]) : null, t ? null : c(Fn, null, {default: () => o}), c(af, xn(this.$props, lf, Object.assign(Object.assign({}, this.$attrs), {
        ...
        return Object.assign(Object.assign({}, ff), {
            ...
            textColorPrimary: n,
            colorPrimary: le(n, {alpha: .12}),
            colorBorderedPrimary: le(n, {alpha: .1}),
            closeIconColorPrimary: n,
            closeIconColorHoverPrimary: n,
            closeIconColorPressedPrimary: n,
            closeColorHoverPrimary: le(n, {alpha: .12}),
            closeColorPressedPrimary: le(n, {alpha: .18}),
            borderInfo: `1px solid ${le(i, {alpha: .3})}`,
            textColorInfo: i,
            colorInfo: le(i, {alpha: .12}),
            colorBorderedInfo: le(i, {alpha: .1}),
            closeIconColorInfo: i,
            closeIconColorHoverInfo: i,
            closeIconColorPressedInfo: i,
            closeColorHoverInfo: le(i, {alpha: .12}),
            closeColorPressedInfo: le(i, {alpha: .18}),
            borderSuccess: `1px solid ${le(l, {alpha: .3})}`,
            textColorSuccess: l,
            colorSuccess: le(l, {alpha: .12}),
            colorBorderedSuccess: le(l, {alpha: .1}),
            closeIconColorSuccess: l,
            closeIconColorHoverSuccess: l,
            closeIconColorPressedSuccess: l,
            closeColorHoverSuccess: le(l, {alpha: .12}),
            closeColorPressedSuccess: le(l, {alpha: .18}),
            borderWarning: `1px solid ${le(d, {alpha: .35})}`,
            textColorWarning: d,
            colorWarning: le(d, {alpha: .15}),
            colorBorderedWarning: le(d, {alpha: .12}),
            closeIconColorWarning: d,
            closeIconColorHoverWarning: d,
            closeIconColorPressedWarning: d,
            closeColorHoverWarning: le(d, {alpha: .12}),
            closeColorPressedWarning: le(d, {alpha: .18}),
            borderError: `1px solid ${le(a, {alpha: .23})}`,
            textColorError: a,
            colorError: le(a, {alpha: .1}),
            colorBorderedError: le(a, {alpha: .08}),
            closeIconColorError: a,
            closeIconColorHoverError: a,
            closeIconColorPressedError: a,
            closeColorHoverError: le(a, {alpha: .12}),
            closeColorPressedError: le(a, {alpha: .18})
        })
    }, pf = {name: "Tag", common: Be, self: hf}, vf = pf, gf = {
        color: Object,
...
`, [j("strong", `
 ...
 `, [ze("disabled", [L("&:hover", "background-color: var(--n-color-checked-hover);"), L("&:active", "background-color: var(--n-color-checked-pressed);")])])])]),
    bf = Object.assign(Object.assign(Object.assign({}, ae.props), gf), {
        ...
        name: "Tag", props: bf, setup(e) {
            const t = O(null), {
                mergedBorderedRef: r,
                mergedClsPrefixRef: o,
                inlineThemeDisabled: n,
                mergedRtlRef: i
            } = Re(e), l = ae("Tag", "-tag", mf, vf, e, o);
            _e(yf, {roundRef: ee(e, "round")});
            ...
            d == null || d();
            const s = Ze(a.avatar, f => f && c("div", {class: `${r}-tag__avatar`}, f)),
                u = Ze(a.icon, f => f && c("div", {class: `${r}-tag__icon`}, f));
            return c("div", {
...
`, [L(">", [B("clear", `
 ...
 `, [Cn({originalTransform: "translateX(-50%) translateY(-50%)", left: "50%", top: "50%"})])])]), Or = q({
        name: "BaseClear",
        ...
        render() {
            ...
            return c("div", {class: `${e}-base-clear`}, c(kn, null, {
                default: () => {
                    var t, r;
                    return this.show ? c("div", {
                        ...
                        "data-clear": !0
                    }, yt(this.$slots.icon, () => [c(pe, {clsPrefix: e}, {default: () => c(bu, null)})])) : c("div", {
                        key: "icon",
    ...
    }, kf = {name: "Input", common: Be, self: Sf}, Pf = kf, ui = Ge("n-input");
...
function zf(e) {
    ...
    function r() {
        ...
        t.value = {start: l, end: d, beforeText: a.slice(0, l), afterText: a.slice(d)}
    }

    function o() {
        var i;
        const {value: l} = t, {value: d} = e;
        if (!l || !d) return;
        const {value: a} = d, {start: s, beforeText: u, afterText: f} = l;
        let h = a.length;
        if (a.endsWith(f)) h = a.length - f.length; else if (a.startsWith(u)) h = u.length; else {
            const p = u[s - 1], v = a.indexOf(p, s - 1);
            v !== -1 && (h = v + 1)
        }
    ...
    return Te(e, n), {recordCursor: r, restoreCursor: o}
}

const Jo = q({
        name: "InputWordCount", setup(e, {slots: t}) {
            const {mergedValueRef: r, maxlengthRef: o, mergedClsPrefixRef: n, countGraphemesRef: i} = ue(ui), l = D(() => {
                const {value: d} = r;
                return d === null || Array.isArray(d) ? 0 : (i.value || $f)(d)
            });
            return () => {
                const {value: d} = o, {value: a} = r;
                return c("span", {class: `${n.value}-input-word-count`}, cl(t.default, {value: a === null || Array.isArray(a) ? "" : a}, () => [d === void 0 ? l.value : `${l.value} / ${d}`]))
            }
        }
    }), Tf = S("input", `
 max-width: 100%;
...
`, [B("input, textarea", `
 ...
 `)])]), _f = Object.assign(Object.assign({}, ae.props), {
        ...
        name: "Input", props: _f, setup(e) {
            ...
            const l = O(null), d = O(null), a = O(null), s = O(null), u = O(null), f = O(null), h = O(null), p = zf(h),
                v = O(null), {localeRef: y} = ro("Input"), w = O(e.defaultValue), x = ee(e, "value"), P = nr(x, w),
                k = Pn(e), {mergedSizeRef: b, mergedDisabledRef: m, mergedStatusRef: R} = k, z = O(!1), A = O(!1),
                $ = O(!1), _ = O(!1);
            let K = null;
            const F = D(() => {
                ...
                return g ? Array.isArray(g) ? g.map(I => ({textDecoration: I})) : [{textDecoration: g}] : ["", ""]
            }), ve = O(void 0), Ce = () => {
                var g, I;
                if (e.type === "textarea") {
                    const {autosize: Z} = e;
                    ...
                    const {paddingTop: ge, paddingBottom: xe, lineHeight: he} = window.getComputedStyle(d.value),
                        it = Number(ge.slice(0, -2)), at = Number(xe.slice(0, -2)),
                        lt = Number(he.slice(0, -2)), {value: Tt} = a;
                    if (!Tt) return;
                    if (Z.minRows) {
                        const It = Math.max(Z.minRows, 1), cr = `${it + at + lt * It}px`;
            ...
            function Q(g) {
                const {onUpdateValue: I, "onUpdate:value": Z, onInput: ge} = e, {nTriggerFormInput: xe} = k;
                I && me(I, g), Z && me(Z, g), ge && me(ge, g), w.value = g, xe()
            }

            function we(g) {
                const {onChange: I} = e, {nTriggerFormChange: Z} = k;
                I && me(I, g), w.value = g, Z()
            }

            function ye(g) {
                const {onBlur: I} = e, {nTriggerFormBlur: Z} = k;
                I && me(I, g), Z()
            }

            function ne(g) {
                const {onFocus: I} = e, {nTriggerFormFocus: Z} = k;
                I && me(I, g), Z()
            }
            ...
            function $e(g, I = 0, Z = "input") {
                ...
                p.recordCursor();
                const xe = De(ge);
                if (xe) if (!e.pair) Z === "input" ? Q(ge) : we(ge); else {
                    let {value: he} = P;
            ...
            function Ni(g) {
                ...
                if (Z !== "INPUT" && Z !== "TEXTAREA") {
                    if (e.resizable) {
                        const {value: ge} = l;
                        if (ge) {
                            const {left: xe, top: he, width: it, height: at} = ge.getBoundingClientRect(), lt = 14;
...
`)
            ...
            const ea = {
                ...
                } = i.value, {left: Da, right: Fa} = pl(La);
                return {
                    "--n-bezier": I,
            ...
            return d == null || d(), c("div", {
            ...
            }, c("div", {class: `${r}-input-wrapper`}, Ze(a.prefix, s => s && c("div", {class: `${r}-input__prefix`}, s)), i === "textarea" ? c(fl, {
                ...
                default: () => {
                    var s, u;
                    const {textAreaScrollContainerWidth: f} = this, h = {width: this.autosize && f && `${f}px`};
                    return c(Ve, null, c("textarea", Object.assign({}, this.inputProps, {
                        ...
                        key: "placeholder"
                    }, this.mergedPlaceholder[0]) : null, this.autosize ? c(hl, {onResize: this.handleTextAreaMirrorResize}, {
                        default: () => c("div", {
            ...
            }) : c("div", {class: `${r}-input__input`}, c("input", Object.assign({type: i === "password" && this.mergedShowPasswordOn && this.passwordVisible ? "text" : i}, this.inputProps, {
                ref: "inputElRef",
            ...
            })), this.showPlaceholder1 ? c("div", {class: `${r}-input__placeholder`}, c("span", null, this.mergedPlaceholder[0])) : null, this.autosize ? c("div", {
                class: `${r}-input__input-mirror`,
                key: "mirror",
                ref: "inputMirrorElRef"
            }, " ") : null), !this.pair && Ze(a.suffix, s => s || this.clearable || this.showCount || this.mergedShowPasswordOn || this.loading !== void 0 ? c("div", {class: `${r}-input__suffix`}, [Ze(a["clear-icon-placeholder"], u => (this.clearable || u) && c(Or, {
                clsPrefix: r,
            ...
            }, this.passwordVisible ? yt(a["password-visible-icon"], () => [c(pe, {clsPrefix: r}, {default: () => c(ii, null)})]) : yt(a["password-invisible-icon"], () => [c(pe, {clsPrefix: r}, {default: () => c(fu, null)})])) : null]) : null)), this.pair ? c("span", {class: `${r}-input__separator`}, yt(a.separator, () => [this.separator])) : null, this.pair ? c("div", {class: `${r}-input-wrapper`}, c("div", {class: `${r}-input__input`}, c("input", {
                ref: "inputEl2Ref",
                type: this.type,
            ...
            }), this.showPlaceholder2 ? c("div", {class: `${r}-input__placeholder`}, c("span", null, this.mergedPlaceholder[1])) : null), Ze(a.suffix, s => (this.clearable || s) && c("div", {class: `${r}-input__suffix`}, [this.clearable && c(Or, {
                clsPrefix: r,
                show: this.showClearButton,
                onClear: this.handleClear
            }, {
            ...
            }), s]))) : null, this.mergedBordered ? c("div", {class: `${r}-input__border`}) : null, this.mergedBordered ? c("div", {class: `${r}-input__state-border`}) : null, this.showCount && i === "textarea" ? c(Jo, null, {
                default: s => {
                    var u;
    ...
    }), wr = Vr && "loading" in document.createElement("img"), Rf = (e = {}) => {
        var t;
        const {root: r = null} = e;
        return {
            hash: `${e.rootMargin || "0px 0px 0px 0px"}-${Array.isArray(e.threshold) ? e.threshold.join(",") : (t = e.threshold) !== null && t !== void 0 ? t : "0"}`,
            options: Object.assign(Object.assign({}, e), {root: (typeof r == "string" ? document.querySelector(r) : r) || document.documentElement})
        }
    }, xr = new WeakMap, Cr = new WeakMap, Sr = new WeakMap, Mf = (e, t, r) => {
        if (!e) return () => {
        };
        const o = Rf(t), {root: n} = o.options;
        let i;
        const l = xr.get(n);
        ...
        i.has(o.hash) ? (a = i.get(o.hash), a[1].has(e) || (d = a[0], a[1].add(e), d.observe(e))) : (d = new IntersectionObserver(f => {
            f.forEach(h => {
                if (h.isIntersecting) {
                    const p = Cr.get(h.target), v = Sr.get(h.target);
                    p && p(), v && (v.value = !0)
                }
            })
    ...
    }, Lf = Et({name: "Tooltip", common: Be, peers: {Popover: io}, self: Bf}), ao = Lf,
    Ef = Et({name: "Ellipsis", common: Be, peers: {Tooltip: ao}}), Af = Ef, Df = {
        padding: "4px 0",
        ...
        return Object.assign(Object.assign({}, Df), {
            ...
            prefixColor: r,
            optionColorHover: n,
            optionColorActive: le(t, {alpha: .1}),
    ...
    }, Nf = Et({name: "Dropdown", common: Be, peers: {Popover: io}, self: Ff}), Hf = Nf,
    jf = Object.assign(Object.assign({}, ar), ae.props), fi = q({
        name: "Tooltip", props: jf, __popover__: !0, setup(e) {
            const t = ae("Tooltip", "-tooltip", void 0, ao, e), r = O(null);
            ...
            }), {popoverRef: r, mergedTheme: t, popoverThemeOverrides: D(() => t.value.self)})
        }, render() {
    ...
    }), Uf = S("ellipsis", {overflow: "hidden"}, [ze("line-clamp", `
 white-space: nowrap;
 display: inline-block;
 vertical-align: bottom;
 max-width: 100%;
...
const Wf = Object.assign(Object.assign({}, ae.props), {
    ...
    name: "Ellipsis", inheritAttrs: !1, props: Wf, setup(e, {slots: t, attrs: r}) {
        const {mergedClsPrefixRef: o} = Re(e), n = ae("Ellipsis", "-ellipsis", Uf, Af, e, o), i = O(null), l = O(null),
            d = O(null), a = O(!1), s = D(() => {
                const {lineClamp: w} = e, {value: x} = a;
                return w !== void 0 ? {
                    textOverflow: "",
                    "-webkit-line-clamp": x ? "" : w
                } : {textOverflow: x ? "" : "ellipsis", "-webkit-line-clamp": ""}
            });
        ...
        function u() {
            ...
            if (P) {
                const {lineClamp: k} = e;
                if (p(P), k !== void 0) w = P.scrollHeight <= P.offsetHeight; else {
                    const {value: b} = l;
        ...
        }), e.lineClamp ? t : c("span", {ref: "triggerInnerRef"}, t));

        function p(w) {
            if (!w) return;
            const x = s.value, P = Qo(o.value);
        ...
        if (t) {
            ...
            return c(fi, Object.assign({ref: "tooltipRef", placement: "top"}, t, {
                getDisabled: this.getTooltipDisabled,
                theme: n.peers.Tooltip,
                themeOverrides: n.peerOverrides.Tooltip
            }), {trigger: r, default: (e = o.tooltip) !== null && e !== void 0 ? e : o.default})
        } else return r()
    }
}), pi = q({
    name: "DropdownDivider", props: {clsPrefix: {type: String, required: !0}}, render() {
    ...
    return {color: t, opacity1Depth: r, opacity2Depth: o, opacity3Depth: n, opacity4Depth: i, opacity5Depth: l}
}, Kf = {name: "Icon", common: Be, self: Vf}, qf = Kf, Gf = S("icon", `
 height: 1em;
 width: 1em;
 line-height: 1em;
 text-align: center;
...
`, [j("color-transition", {transition: "color .3s var(--n-bezier)"}), j("depth", {color: "var(--n-color)"}, [L("svg", {
    opacity: "var(--n-opacity)",
    transition: "opacity .3s var(--n-bezier)"
})]), L("svg", {height: "1em", width: "1em"})]), Xf = Object.assign(Object.assign({}, ae.props), {
    depth: [String, Number],
    size: [Number, String],
    color: String,
    component: Object
}), Yf = q({
    _n_icon__: !0, name: "Icon", inheritAttrs: !1, props: Xf, setup(e) {
        const {mergedClsPrefixRef: t, inlineThemeDisabled: r} = Re(e), o = ae("Icon", "-icon", Gf, qf, e, t),
            n = D(() => {
                const {depth: l} = e, {common: {cubicBezierEaseInOut: d}, self: a} = o.value;
                if (l !== void 0) {
                    const {color: s, [`opacity${l}Depth`]: u} = a;
                    return {"--n-bezier": d, "--n-color": s, "--n-opacity": u}
                }
        ...
        return !((e = t == null ? void 0 : t.$options) === null || e === void 0) && e._n_icon__ && Kr("icon", "don't wrap `n-icon` inside `n-icon`"), i == null || i(), c("i", Lt(this.$attrs, {
            role: "img",
            class: [`${o}-icon`, l, {[`${o}-icon--depth`]: r, [`${o}-icon--color-transition`]: r !== void 0}],
            style: [this.cssVars, this.mergedStyle]
        }), n ? c(n) : this.$slots)
    }
}), lo = Ge("n-dropdown-menu"), lr = Ge("n-dropdown"), tn = Ge("n-dropdown-option");
...
const gi = q({
        ...
        setup(e) {
            const t = ue(lr), {
                    ...
                    nodePropsRef: v,
                    menuPropsRef: y
                } = t, w = ue(tn, null), x = ue(lo), P = ue(tr), k = D(() => e.tmNode.rawNode), b = D(() => {
                    const {value: N} = h;
                    ...
                    if (Y) return !1;
                    const {value: re} = r, {value: ve} = o, {value: Ce} = n, {value: W} = i;
                    return re !== null ? W.includes(N) : ve !== null ? W.includes(N) && W[W.length - 1] !== N : Ce !== null ? W.includes(N) : !1
                }), z = D(() => o.value === null && !d.value), A = Ml(R, 300, z),
                $ = D(() => !!(w != null && w.enteringSubmenuRef.value)), _ = O(!1);
            _e(tn, {enteringSubmenuRef: _});
            ...
            function T(N) {
                ...
                Y && !Io({target: Y}, "dropdownOption") && !Io({target: Y}, "scrollbarRail") && (r.value = null)
            }

            function H() {
                const {value: N} = b, {tmNode: Y} = e;
            ...
            return {
                ...
                hasSubmenu: b,
                pending: We(() => {
                    const {value: N} = i, {key: Y} = e.tmNode;
                    return N.includes(Y)
                }),
                childActive: We(() => {
                    const {value: N} = l, {key: Y} = e.tmNode, re = N.findIndex(ve => Y === ve);
        ...
        render() {
            ...
            const y = {
                ...
                onMouseleave: this.handleMouseLeave,
                onClick: this.handleClick
            }, w = f == null ? void 0 : f(o), x = c("div", Object.assign({
                class: [`${i}-dropdown-option`, w == null ? void 0 : w.class],
                "data-dropdown-option": !0
            }, w), c("div", Lt(y, h), [c("div", {class: [`${i}-dropdown-option-body__prefix`, l && `${i}-dropdown-option-body__prefix--show-icon`]}, [s ? s(o) : Yt(o.icon)]), c("div", {
                "data-dropdown-option": !0,
            ...
            }, this.hasSubmenu ? c(Yf, null, {default: () => c(uu, null)}) : null)]), this.hasSubmenu ? c(Dn, null, {
                default: () => [c(Fn, null, {
                    default: () => c("div", {class: `${i}-dropdown-offset-container`}, c(Nn, {
                        show: this.mergedShowSubmenu,
                        placement: this.placement,
                        to: p && this.popoverBody || void 0,
                        teleportDisabled: !p
                    }, {
                        default: () => c("div", {class: `${i}-dropdown-menu-wrapper`}, r ? c(bt, {
        ...
        setup() {
            ...
            return {labelField: o, showIcon: e, hasSubmenu: t, renderLabel: r, nodeProps: n, renderOption: i}
        },
        render() {
            var e;
            const {
                    ...
                    renderLabel: i,
                    renderOption: l
                } = this, {rawNode: d} = this.tmNode,
                a = c("div", Object.assign({class: `${t}-dropdown-option`}, n == null ? void 0 : n(d)), c("div", {class: `${t}-dropdown-option-body ${t}-dropdown-option-body--group`}, c("div", {
                    "data-dropdown-option": !0,
        ...
        render() {
            const {tmNode: e, parentKey: t, clsPrefix: r} = this, {children: o} = e;
            return c(Ve, null, c(Qf, {clsPrefix: r, tmNode: e, key: e.key}), o == null ? void 0 : o.map(n => {
                const {rawNode: i} = n;
        ...
        name: "DropdownRenderOption", props: {tmNode: {type: Object, required: !0}}, render() {
        ...
        setup(e) {
            ...
            _e(lo, {
                showIconRef: D(() => {
                    ...
                    return e.tmNodes.some(i => {
                        var l;
                        if (i.isGroup) return (l = i.children) === null || l === void 0 ? void 0 : l.some(({rawNode: a}) => n ? n(a) : a.icon);
                        const {rawNode: d} = i;
                        return n ? n(d) : d.icon
                    })
                }), hasSubmenuRef: D(() => {
                    ...
                    return e.tmNodes.some(i => {
                        var l;
                        if (i.isGroup) return (l = i.children) === null || l === void 0 ? void 0 : l.some(({rawNode: a}) => Br(a, n));
                        const {rawNode: d} = i;
                        return Br(d, n)
                    })
                })
            ...
            const o = O(null);
            return _e(Ar, null), _e(Dr, null), _e(tr, o), {bodyRef: o}
        },
        render() {
            const {parentKey: e, clsPrefix: t, scrollable: r} = this, o = this.tmNodes.map(n => {
                const {rawNode: i} = n;
                return i.show === !1 ? null : Jf(i) ? c(th, {tmNode: n, key: n.key}) : vi(i) ? c(pi, {
                    clsPrefix: t,
                    key: n.key
                }) : Zf(i) ? c(eh, {clsPrefix: t, tmNode: n, parentKey: e, key: n.key}) : c(gi, {
                    clsPrefix: t,
                    tmNode: n,
                    parentKey: e,
                    key: n.key,
            ...
            return c("div", {
                ...
                ref: "bodyRef"
            }, r ? c(wn, {contentClass: `${t}-dropdown-menu__content`}, {default: () => o}) : o, this.showArrow ? di({
                clsPrefix: t,
...
`, [$n(), S("dropdown-option", `
 ...
 `)])]), oh = {
        ...
        value: [String, Number]
    }, nh = Object.keys(ar), ih = Object.assign(Object.assign(Object.assign({}, ar), oh), ae.props), rn = q({
        name: "Dropdown", inheritAttrs: !1, props: ih, setup(e) {
            const t = O(!1), r = nr(ee(e, "show"), t), o = D(() => {
                ...
                }), n = D(() => o.value.treeNodes), i = O(null), l = O(null), d = O(null), a = D(() => {
                    var F, M, C;
                    return (C = (M = (F = i.value) !== null && F !== void 0 ? F : l.value) !== null && M !== void 0 ? M : d.value) !== null && C !== void 0 ? C : null
                }), s = D(() => o.value.getPath(a.value).keyPath), u = D(() => o.value.getPath(e.value).keyPath),
                f = We(() => e.keyboard && r.value);
            El({
                keydown: {
                    ArrowUp: {prevent: !0, handler: m},
                    ArrowRight: {prevent: !0, handler: b},
                    ArrowDown: {prevent: !0, handler: R},
                    ArrowLeft: {prevent: !0, handler: k},
                    Enter: {prevent: !0, handler: z},
                    Escape: P
                }
            }, f);
            const {mergedClsPrefixRef: h, inlineThemeDisabled: p} = Re(e), v = ae("Dropdown", "-dropdown", rh, Hf, e, h);
            _e(lr, {
            ...
            function A() {
                var F;
                const {value: M} = o, {value: C} = a;
                return !M || C === null ? null : (F = M.getNode(C)) !== null && F !== void 0 ? F : null
            }

            function $(F) {
                const {value: M} = a, {value: {getFirstAvailableNode: C}} = o;
                let T = null;
                if (M === null) {
                    const H = C();
                    H !== null && (T = H.key)
            ...
            const _ = D(() => {
                const {size: F, inverted: M} = e, {common: {cubicBezierEaseInOut: C}, self: T} = v.value, {
                    padding: H,
                    dividerColor: N,
                    borderRadius: Y,
            ...
            const e = (o, n, i, l, d) => {
                ...
                const f = (u == null ? void 0 : u(void 0, this.tmNodes.map(p => p.rawNode))) || {}, h = {
                    ref: Il(n),
    ...
    }), ah = {gapSmall: "4px 8px", gapMedium: "8px 12px", gapLarge: "12px 16px"}, lh = () => ah,
    sh = {name: "Space", self: lh}, dh = sh;
let kr;
const ch = () => {
    if (!Vr) return !0;
    if (kr === void 0) {
    ...
    name: "Space", props: uh, setup(e) {
        const {mergedClsPrefixRef: t, mergedRtlRef: r} = Re(e), o = ae("Space", "-space", void 0, dh, e, t),
            n = kt("Space", r, t);
        return {
            useGap: ch(), rtlEnabled: n, mergedClsPrefix: t, margin: D(() => {
                const {size: i} = e;
                if (Array.isArray(i)) return {horizontal: i[0], vertical: i[1]};
                if (typeof i == "number") return {horizontal: i, vertical: i};
                const {self: {[ie("gap", i)]: l}} = o.value, {row: d, col: a} = ml(l);
                return {horizontal: $o(a), vertical: $o(d)}
            })
        }
    }, render() {
        const {
        ...
        const p = `${i.horizontal}px`, v = `${i.horizontal / 2}px`, y = `${i.vertical}px`, w = `${i.vertical / 2}px`,
            x = h.length - 1, P = o.startsWith("space-");
        return c("div", {
            role: "none",
            ...
            role: "none",
            style: [n, {maxWidth: "100%"}, s ? "" : e ? {marginBottom: b !== x ? y : ""} : a ? {
...
const ph = Et({name: "Image", common: Be, peers: {Tooltip: ao}, self: hh}), vh = e => {
    const {
        textColor2: t,
        cardColor: r,
        modalColor: o,
...
}, gh = {name: "List", common: Be, self: vh}, mh = gh, bh = e => {
    const {
        infoColor: t,
        successColor: r,
        warningColor: o,
...
}, yh = {name: "Progress", common: Be, self: bh}, yi = yh, wh = {
...
}, Ch = {name: "Result", common: Be, self: xh}, Sh = Ch, kh = {
    thPaddingSmall: "6px",
...
}, $h = {name: "Table", common: Be, self: Ph}, zh = $h, Th = e => {
    const {textColor1: t, textColor2: r, fontWeightStrong: o, fontSize: n} = e;
    return {fontSize: n, titleTextColor: t, textColor: r, titleFontWeight: o}
}, Ih = {name: "Thing", common: Be, self: Th}, _h = Ih, Rh = e => {
    const {
        iconColor: t,
        primaryColor: r,
        errorColor: o,
    ...
    return {
        ...
        itemColorHover: s,
        itemColorHoverError: le(o, {alpha: .06}),
        itemTextColor: n,
...
}, Mh = Et({name: "Upload", common: Be, peers: {Button: bl, Progress: yi}, self: Rh}), Oh = Mh, Bh = c("svg", {
    viewBox: "0 0 20 20",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
}, c("path", {
 ...
 `)])]), Vt = 32, wi = q({
    ...
    setup(e) {
        ...
        let r = null;
        const o = O(null), n = O(null), i = O(void 0), l = O(!1), d = O(!1), {localeRef: a} = ro("Image");

        function s() {
            const {value: U} = n;
            if (!r || !U) return;
            const {style: J} = U, V = r.getBoundingClientRect(), de = V.left + V.width / 2, fe = V.top + V.height / 2;
        ...
        let f = 0, h = 0, p = 0, v = 0, y = 0, w = 0, x = 0, P = 0, k = !1;
        ...
        function m(U) {
            const {mouseUpClientX: J, mouseUpClientY: V, mouseDownClientX: de, mouseDownClientY: fe} = U, Me = de - J,
                $e = fe - V, De = `vertical${$e > 0 ? "Top" : "Bottom"}`, Ke = `horizontal${Me > 0 ? "Left" : "Right"}`;
            return {moveVerticalDirection: De, moveHorizontalDirection: Ke, deltaHorizontal: Me, deltaVertical: $e}
        }

        function R(U) {
            const {value: J} = o;
            if (!J) return {offsetX: 0, offsetY: 0};
        ...
        function z(U) {
            ...
            const {clientX: J, clientY: V} = U;
            k = !1;
            const de = m({mouseUpClientX: J, mouseUpClientY: V, mouseDownClientX: x, mouseDownClientY: P}), fe = R(de);
        ...
        function ve() {
            const {value: U} = o;
            if (!U) return 1;
            const {innerWidth: J, innerHeight: V} = window, de = Math.max(1, U.naturalHeight / (V - Vt)),
        ...
        function Ce() {
            const {value: U} = o;
            if (!U) return 1;
            const {innerWidth: J, innerHeight: V} = window, de = U.naturalHeight / (V - Vt),
        ...
        function Q(U = !0) {
            ...
            let Me = "";
            if (typeof fe == "string") Me = fe + ";"; else for (const De in fe) Me += `${yc(De)}: ${fe[De]};`;
        ...
        const Ne = D(() => {
            const {
                ...
                self: {toolbarIconColor: J, toolbarBorderRadius: V, toolbarBoxShadow: de, toolbarColor: fe}
            } = t.value;
            return {
                "--n-bezier": U,
        ...
        }), {inlineThemeDisabled: He} = Re(), Ee = He ? Fe("image-preview", void 0, Ne, e) : void 0;
    ...
    render() {
        ...
        return c(Ve, null, (t = (e = this.$slots).default) === null || t === void 0 ? void 0 : t.call(e), c(vn, {show: this.show}, {
            default: () => {
                var o;
                ...
                }), this.showToolbar ? c(bt, {name: "fade-in-transition", appear: this.appear}, {
                    default: () => {
                        if (!this.show) return null;
                        const {withTooltip: n} = this;
                        return c("div", {class: `${r}-image-preview-toolbar`}, this.onPrev ? c(Ve, null, n(c(pe, {
                            clsPrefix: r,
                            onClick: this.handleSwitchPrev
                        }, {default: () => Bh}), "tipPrevious"), n(c(pe, {
                            clsPrefix: r,
                            onClick: this.handleSwitchNext
                        }, {default: () => Lh}), "tipNext")) : null, n(c(pe, {
                            clsPrefix: r,
                            onClick: this.rotateCounterclockwise
                        }, {default: () => c(xu, null)}), "tipCounterclockwise"), n(c(pe, {
                            clsPrefix: r,
                            onClick: this.rotateClockwise
                        }, {default: () => c(wu, null)}), "tipClockwise"), n(c(pe, {
                            clsPrefix: r,
                            onClick: this.resizeToOrignalImageSize
                        }, {default: () => c(ku, null)}), "tipOriginalSize"), n(c(pe, {
                            clsPrefix: r,
                            onClick: this.zoomOut
                        }, {default: () => c(Su, null)}), "tipZoomOut"), n(c(pe, {
                            clsPrefix: r,
                            onClick: this.zoomIn
                        }, {default: () => c(Cu, null)}), "tipZoomIn"), n(c(pe, {
                            clsPrefix: r,
                            onClick: this.toggleShow
                        }, {default: () => Eh}), "tipClose"))
                    }
                ...
                })), [[Hr, {enabled: this.show}]])) : null
            }
        }))
    }
}), xi = Ge("n-image-group"), Dh = so, Fh = q({
    name: "ImageGroup", props: Dh, setup(e) {
        let t;
        const {mergedClsPrefixRef: r} = Re(e), o = `c${$r()}`, n = Fr(), i = a => {
            var s;
        ...
        _e(xi, {
            mergedClsPrefixRef: r, setPreviewSrc: i, setThumbnailEl: a => {
                var s;
        ...
        const d = O(null);
        return {mergedClsPrefix: r, previewInstRef: d, next: () => l(1), prev: () => l(-1)}
    }, render() {
        return c(wi, {
            theme: this.theme,
    ...
    name: "Image", props: Nh, inheritAttrs: !1, setup(e) {
        const t = O(null), r = O(!1), o = O(null), n = ue(xi, null), {mergedClsPrefixRef: i} = n || Re(e), l = {
            click: () => {
        ...
        const a = O(!1);
        return _e(bi, {previewedImgPropsRef: ee(e, "previewedImgProps")}), Object.assign({
            mergedClsPrefix: i,
        ...
        const {mergedClsPrefix: r, imgProps: o = {}, loaded: n, $attrs: i, lazy: l} = this,
            ...
            a = this.src || o.src || "", s = c("img", Object.assign(Object.assign({}, o), {
                ref: "imageRef",
 ...
 `))]), jh = Object.assign(Object.assign({}, ae.props), {
    ...
    name: "List", props: jh, setup(e) {
        const {mergedClsPrefixRef: t, inlineThemeDisabled: r, mergedRtlRef: o} = Re(e), n = kt("List", o, t),
            i = ae("List", "-list", Hh, mh, e, t);
        _e(Ci, {showDividerRef: ee(e, "showDivider"), mergedClsPrefixRef: t});
        const l = D(() => {
            const {
        ...
        return o == null || o(), c("ul", {
            ...
            style: this.cssVars
        }, t.header ? c("div", {class: `${r}-list__header`}, t.header()) : null, (e = t.default) === null || e === void 0 ? void 0 : e.call(t), t.footer ? c("div", {class: `${r}-list__footer`}, t.footer()) : null)
    }
}), Wh = q({
    name: "ListItem", setup() {
        const e = ue(Ci, null);
        ...
        return c("li", {class: `${t}-list-item`}, e.prefix ? c("div", {class: `${t}-list-item__prefix`}, e.prefix()) : null, e.default ? c("div", {class: `${t}-list-item__main`}, e) : null, e.suffix ? c("div", {class: `${t}-list-item__suffix`}, e.suffix()) : null, this.showDivider && c("div", {class: `${t}-list-item__divider`}))
    }
});
...
const Vh = L([S("progress", {display: "inline-block"}, [S("progress-icon", `
 color: var(--n-icon-color);
 transition: color .3s var(--n-bezier);
 `), j("line", `
 width: 100%;
 ...
 `)]), Kh = {success: c(qr, null), error: c(Gr, null), warning: c(Xr, null), info: c(Yr, null)}, qh = q({
    name: "ProgressLine",
    props: {
        clsPrefix: {type: String, required: !0},
    ...
    setup(e, {slots: t}) {
        const r = D(() => qe(e.height)),
            o = D(() => e.railBorderRadius !== void 0 ? qe(e.railBorderRadius) : e.height !== void 0 ? qe(e.height, {c: .5}) : ""),
            n = D(() => e.fillBorderRadius !== void 0 ? qe(e.fillBorderRadius) : e.railBorderRadius !== void 0 ? qe(e.railBorderRadius) : e.height !== void 0 ? qe(e.height, {c: .5}) : "");
        return () => {
            const {
            ...
            return c("div", {class: `${y}-progress-content`, role: "none"}, c("div", {
                class: `${y}-progress-graph`,
                "aria-hidden": !0
            }, c("div", {class: [`${y}-progress-graph-line`, {[`${y}-progress-graph-line--indicator-${i}`]: !0}]}, c("div", {
                class: `${y}-progress-graph-line-rail`,
                style: [{backgroundColor: l, height: r.value, borderRadius: o.value}, d]
            }, c("div", {
                ...
                "aria-hidden": !0
            }, c(pe, {clsPrefix: y}, {default: () => Kh[f]}))) : null)
        }
    }
}), Gh = {success: c(qr, null), error: c(Gr, null), warning: c(Xr, null), info: c(Yr, null)}, Xh = q({
    name: "ProgressCircle",
    props: {
        clsPrefix: {type: String, required: !0},
        status: {type: String, required: !0},
    ...
    setup(e, {slots: t}) {
        function r(o, n, i) {
            const {gapDegree: l, viewBoxWidth: d, strokeWidth: a} = e, s = 50, u = 0, f = s, h = 0, p = 2 * s,
                v = 50 + a / 2, y = `M ${v},${v} m ${u},${f}
      a ${s},${s} 0 1 1 ${h},${-p}
      a ${s},${s} 0 1 1 ${-h},${p}`, w = Math.PI * 2 * s, x = {
            ...
            return {pathString: y, pathStyle: x}
        }
        ...
        return () => {
            const {
                    ...
                    gapOffsetDegree: h,
                    clsPrefix: p
                } = e, {pathString: v, pathStyle: y} = r(100, 0, n), {pathString: w, pathStyle: x} = r(a, l, o),
                P = 100 + i;
            return c("div", {class: `${p}-progress-content`, role: "none"}, c("div", {
                class: `${p}-progress-graph`,
                "aria-hidden": !0
            }, c("div", {
                class: `${p}-progress-graph-circle`,
                style: {transform: h ? `rotate(${h}deg)` : void 0}
            }, c("svg", {viewBox: `0 0 ${P} ${P}`}, c("g", null, c("path", {
                ...
                "aria-hidden": !0
            }, c(pe, {clsPrefix: p}, {default: () => Gh[d]})) : c("div", {
                class: `${p}-progress-text`,
                style: {color: u},
                role: "none"
            }, c("span", {class: `${p}-progress-text__percentage`}, a), c("span", {class: `${p}-progress-text__unit`}, f))) : null)
        }
    }
});
...
const Yh = q({
    ...
    setup(e, {slots: t}) {
        ...
        return () => {
            ...
            return c("div", {class: `${f}-progress-content`, role: "none"}, c("div", {
                class: `${f}-progress-graph`,
                "aria-hidden": !0
            }, c("div", {class: `${f}-progress-graph-circle`}, c("svg", {viewBox: `0 0 ${o} ${o}`}, u.map((h, p) => c("g", {key: p}, c("path", {
                class: `${f}-progress-graph-circle-rail`,
                d: on(o / 2 - n / 2 * (1 + 2 * p) - i * p, n, o),
                "stroke-width": n,
                "stroke-linecap": "round",
                fill: "none",
                style: [{strokeDashoffset: 0, stroke: a[p]}, s[p]]
            }), c("path", {
                ...
                "stroke-linecap": "round",
                fill: "none",
                style: {strokeDasharray: r.value[p], strokeDashoffset: 0, stroke: d[p]}
            })))))), l && t.default ? c("div", null, c("div", {class: `${f}-progress-text`}, t.default())) : null)
        }
    }
    ...
    name: "Progress", props: Zh, setup(e) {
        const t = D(() => e.indicatorPlacement || e.indicatorPosition), r = D(() => {
                if (e.gapDegree || e.gapDegree === 0) return e.gapDegree;
                if (e.type === "dashboard") return 75
            }), {mergedClsPrefixRef: o, inlineThemeDisabled: n} = Re(e), i = ae("Progress", "-progress", Vh, yi, e, o),
            l = D(() => {
                const {status: a} = e, {
...
}), Qh = c("svg", {xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 36 36"}, c("circle", {
    fill: "#FFCB4C",
    cx: "18",
    cy: "17.018",
    r: "17"
    ...
    rx: "2.125",
    ry: "2.656"
}), c("ellipse", {fill: "#65471B", cx: "24.375", cy: "12.236", rx: "2.125", ry: "2.656"}), c("path", {
    fill: "#F19020",
...
})), ep = c("svg", {xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 36 36"}, c("path", {
    fill: "#FFCC4D",
    d: "M36 18c0 9.941-8.059 18-18 18-9.94 0-18-8.059-18-18C0 8.06 8.06 0 18 0c9.941 0 18 8.06 18 18"
}), c("ellipse", {fill: "#664500", cx: "18", cy: "27", rx: "5", ry: "6"}), c("path", {
    fill: "#664500",
...
})), tp = c("svg", {xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 36 36"}, c("ellipse", {
    fill: "#292F33",
    cx: "18",
    cy: "26",
    rx: "18",
    ry: "10"
}), c("ellipse", {fill: "#66757F", cx: "18", cy: "24", rx: "18", ry: "10"}), c("path", {
    fill: "#E1E8ED",
    ...
    fill: "#5C913B"
})), rp = c("svg", {xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 36 36"}, c("path", {
    fill: "#EF9645",
...
`, [S("result-icon", `
 ...
 `)])]), np = {
    ...
    name: "Result", props: ip, setup(e) {
        const {mergedClsPrefixRef: t, inlineThemeDisabled: r} = Re(e), o = ae("Result", "-result", op, Sh, e, t),
            n = D(() => {
 ...
 `)]))]), sp = Object.assign(Object.assign({}, ae.props), {
    ...
    name: "Table", props: sp, setup(e) {
        const {mergedClsPrefixRef: t, inlineThemeDisabled: r, mergedRtlRef: o} = Re(e),
            n = ae("Table", "-table", lp, zh, e, t), i = kt("Table", o, t), l = D(() => {
                const {size: a} = e, {
                    self: {
                        borderColor: s,
                        tdColor: u,
...
`, [S("thing-avatar", `
 ...
 `)])])]), up = Object.assign(Object.assign({}, ae.props), {
    ...
    name: "Thing", props: up, setup(e, {slots: t}) {
        const {mergedClsPrefixRef: r, inlineThemeDisabled: o, mergedRtlRef: n} = Re(e),
            i = ae("Thing", "-thing", cp, _h, e, r), l = kt("Thing", n, r), d = D(() => {
                const {
                    self: {titleTextColor: s, textColor: u, titleFontWeight: f, fontSize: h},
        ...
        return () => {
            ...
            }, t.avatar && e.contentIndented ? c("div", {class: `${u}-thing-avatar`}, t.avatar()) : null, c("div", {class: `${u}-thing-main`}, !e.contentIndented && (t.header || e.title || t["header-extra"] || e.titleExtra || t.avatar) ? c("div", {class: `${u}-thing-avatar-header-wrapper`}, t.avatar ? c("div", {class: `${u}-thing-avatar`}, t.avatar()) : null, t.header || e.title || t["header-extra"] || e.titleExtra ? c("div", {class: `${u}-thing-header-wrapper`}, c("div", {class: `${u}-thing-header`}, t.header || e.title ? c("div", {class: `${u}-thing-header__title`}, t.header ? t.header() : e.title) : null, t["header-extra"] || e.titleExtra ? c("div", {class: `${u}-thing-header__extra`}, t["header-extra"] ? t["header-extra"]() : e.titleExtra) : null), t.description || e.description ? c("div", {
                class: `${u}-thing-main__description`,
                style: e.descriptionStyle
            }, t.description ? t.description() : e.description) : null) : null) : c(Ve, null, t.header || e.title || t["header-extra"] || e.titleExtra ? c("div", {class: `${u}-thing-header`}, t.header || e.title ? c("div", {class: `${u}-thing-header__title`}, t.header ? t.header() : e.title) : null, t["header-extra"] || e.titleExtra ? c("div", {class: `${u}-thing-header__extra`}, t["header-extra"] ? t["header-extra"]() : e.titleExtra) : null) : null, t.description || e.description ? c("div", {
                class: `${u}-thing-main__description`,
                style: e.descriptionStyle
            }, t.description ? t.description() : e.description) : null), t.default || e.content ? c("div", {
                class: `${u}-thing-main__content`,
                style: e.contentStyle
            }, t.default ? t.default() : e.content) : null, t.footer ? c("div", {class: `${u}-thing-main__footer`}, t.footer()) : null, t.action ? c("div", {class: `${u}-thing-main__action`}, t.action()) : null))
        }
    }
}), zt = Ge("n-upload"), ki = "__UPLOAD_DRAGGER__", fp = q({
    name: "UploadDragger", [ki]: !0, setup(e, {slots: t}) {
        const r = ue(zt, null);
        return r || Pt("upload-dragger", "`n-upload-dragger` must be placed inside `n-upload`."), () => {
            ...
            return c("div", {class: [`${o}-upload-dragger`, (n || i) && `${o}-upload-dragger--disabled`]}, t)
        }
    }
});
...
const $i = e => e.includes("image/"), nn = (e = "") => {
    const t = e.split("/"), o = t[t.length - 1].split(/#|\?/)[0];
    return (/\.[^./\\]*$/.exec(o) || [""])[0]
}, an = /(webp|svg|png|gif|jpg|jpeg|jfif|bmp|dpg|ico)$/i, zi = e => {
    if (e.type) return $i(e.type);
    const t = nn(e.name || "");
    if (an.test(t)) return !0;
    const r = e.thumbnailUrl || e.url || "", o = nn(r);
            ...
            a.forEach(s => {
                if (s) {
                    if (i(), t && vp(s)) {
                        ...
                        r.push({file: u, entry: s, source: "dnd"}), l()
                    }, () => {
                        l()
                    }));
                    l()
...
const yp = (e, t) => {
    ...
    name: "UploadTrigger", props: {abstract: Boolean}, setup(e, {slots: t}) {
        const r = ue(zt, null);
        ...
        return () => {
            ...
            return e.abstract ? (k = t.default) === null || k === void 0 ? void 0 : k.call(t, {
                ...
                onDragenter: w,
                onDragleave: x
            }, p.value ? c(fp, null, {default: () => yt(t.default, () => [c(pe, {clsPrefix: b}, {default: () => c(du, null)})])}) : t)
        }
    }
}), wp = q({
    name: "UploadProgress",
    props: {show: Boolean, percentage: {type: Number, required: !0}, status: {type: String, required: !0}},
    setup() {
        return {mergedTheme: ue(zt).mergedThemeRef}
    },
    render() {
        return c(In, null, {
...
const Kt = {paddingMedium: "0 3px", heightMedium: "24px", iconSizeMedium: "18px"}, kp = q({
    name: "UploadFile",
    props: {
        clsPrefix: {type: String, required: !0},
    ...
    setup(e) {
        const t = ue(zt), r = O(null), o = O(""), n = D(() => {
            const {file: m} = e;
        ...
        }), f = We(() => o.value || e.file.thumbnailUrl || e.file.url), h = D(() => {
        ...
        function w(m) {
            ...
            Promise.resolve(A ? A({file: Object.assign({}, m), fileList: $}) : !0).then(_ => {
                if (_ === !1) return;
                const K = Object.assign({}, m, {status: "removed"});
                R.delete(m.id), z(K, void 0, {remove: !0})
            })
        }
        ...
        function P(m) {
            const {xhrMap: R} = t, z = R.get(m.id);
            z == null || z.abort(), w(Object.assign({}, m))
        }

        function k() {
            const {onPreviewRef: {value: m}} = t;
            if (m) m(e.file); else if (e.listType === "image-card") {
                const {value: R} = r;
                if (!R) return;
                R.click()
            }
    ...
    render() {
        ...
        let i;
        const l = r === "image";
        l || r === "image-card" ? i = !this.shouldUseThumbnailUrl(o) || !this.mergedThumbnailUrl ? c("span", {class: `${e}-upload-file-info__thumbnail`}, n ? n(o) : zi(o) ? c(pe, {clsPrefix: e}, {default: () => xp}) : c(pe, {clsPrefix: e}, {default: () => Cp})) : c("a", {
            ...
            src: this.mergedThumbnailUrl || void 0,
            alt: o.name
        })) : i = c("span", {class: `${e}-upload-file-info__thumbnail`}, n ? n(o) : c(pe, {clsPrefix: e}, {default: () => c(cu, null)}));
        const a = c(wp, {show: this.showProgress, percentage: o.percentage || 0, status: this.progressStatus}),
            s = r === "text" || r === "image";
        return c("div", {class: [`${e}-upload-file`, `${e}-upload-file--${this.progressStatus}-status`, o.url && o.status !== "error" && r !== "image-card" && `${e}-upload-file--with-url`, `${e}-upload-file--${r}-type`]}, c("div", {class: `${e}-upload-file-info`}, i, c("div", {class: `${e}-upload-file-info__name`}, s && (o.url && o.status !== "error" ? c("a", {
            rel: "noopener noreferer",
            target: "_blank",
            href: o.url || void 0,
            onClick: this.handlePreviewClick
        }, o.name) : c("span", {onClick: this.handlePreviewClick}, o.name)), l && a), c("div", {class: [`${e}-upload-file-info__action`, `${e}-upload-file-info__action--${r}-type`]}, this.showPreviewButton ? c(ce, {
            key: "preview",
            quaternary: !0,
        ...
        }, {icon: () => c(pe, {clsPrefix: e}, {default: () => c(ii, null)})}) : null, (this.showRemoveButton || this.showCancelButton) && !this.disabled && c(ce, {
            key: "cancelOrTrash",
            theme: t.peers.Button,
            themeOverrides: t.peerOverrides.Button,
            quaternary: !0,
            ...
            icon: () => c(kn, null, {
                default: () => this.showRemoveButton ? c(pe, {
                    clsPrefix: e,
                    key: "trash"
                }, {default: () => c(hu, null)}) : c(pe, {clsPrefix: e, key: "cancel"}, {default: () => c(gu, null)})
            })
            ...
            themeOverrides: t.peerOverrides.Button,
            builtinThemeOverrides: Kt
        }, {icon: () => c(pe, {clsPrefix: e}, {default: () => c(yu, null)})}), this.showDownloadButton ? c(ce, {
            key: "download",
            quaternary: !0,
            type: this.buttonType,
            ...
            themeOverrides: t.peerOverrides.Button,
            builtinThemeOverrides: Kt
        }, {icon: () => c(pe, {clsPrefix: e}, {default: () => c(pu, null)})}) : null)), !l && a)
    }
}), Pp = q({
    name: "UploadFileList", setup(e, {slots: t}) {
        const r = ue(zt, null);
        ...
        const {
            ...
            } = r, p = D(() => i.value === "image-card"),
            v = () => l.value.map(w => c(kp, {clsPrefix: n.value, key: w.id, file: w, listType: i.value})),
            y = () => p.value ? c(Fh, Object.assign({}, h.value), {default: v}) : c(In, {group: !0}, {default: v});
        return () => {
            const {value: w} = n, {value: x} = o;
            return c("div", {
 ...
 transition: background-color .3s var(--n-bezier);
 border-radius: var(--n-border-radius);
 `, [To(), S("progress", [To({foldPadding: !0})]), L("&:hover", `
 ...
 justify-content: flex-end;
 opacity: 0;
 `, [S("button", [L("&:not(:last-child)", {marginRight: "4px"}), S("base-icon", [L("svg", [Cn()])])]), j("image-type", `
 position: relative;
 max-width: 80px;
 width: auto;
 `), j("image-card-type", `
...
function zp(e, t, r) {
    ...
    function l(a) {
        var s;
        let u = Object.assign({}, t, {status: "error", percentage: i});
    ...
    function d(a) {
        ...
        let u = Object.assign({}, t, {status: "finished", percentage: i});
    ...
    return {
        handleXHRLoad: d, handleXHRError: l, handleXHRAbort(a) {
            const s = Object.assign({}, t, {status: "removed", file: null, percentage: i});
            n.delete(t.id), o(s, a)
        }, handleXHRProgress(a) {
            const s = Object.assign({}, t, {status: "uploading"});
...
function Tp(e) {
    ...
    let s = 0;
    d({
        file: r, data: o, headers: n, withCredentials: i, action: l, onProgress(u) {
            const f = Object.assign({}, r, {status: "uploading"}), h = u.percent;
            f.percentage = h, s = h, a(f)
        }, onFinish() {
            var u;
            let f = Object.assign({}, r, {status: "finished", percentage: s});
            f = Bt(((u = t.onFinish) === null || u === void 0 ? void 0 : u.call(t, {file: f})) || f), a(f)
        }, onError() {
            var u;
            let f = Object.assign({}, r, {status: "error", percentage: s});
            f = Bt(((u = t.onError) === null || u === void 0 ? void 0 : u.call(t, {file: f})) || f), a(f)
        }
    })
}
...
function Mp(e, t, r, {method: o, action: n, withCredentials: i, responseType: l, headers: d, data: a}) {
    ...
    if (Rp(u, a, r), u.append(t, r.file), Ip(e, r, s), n !== void 0) {
        ...
        const f = Object.assign({}, r, {status: "uploading"});
        e.doChange(f)
    }
}
...
const Op = Object.assign(Object.assign({}, ae.props), {
        ...
        onPreview: Function,
        shouldUseThumbnailUrl: {type: Function, default: e => pp ? zi(e) : !1},
        ...
        name: "Upload", props: Op, setup(e) {
            e.abstract && e.listType === "image-card" && Pt("upload", "when the list-type is image-card, abstract is not supported.");
            const {mergedClsPrefixRef: t, inlineThemeDisabled: r} = Re(e), o = ae("Upload", "-upload", $p, Oh, e, t),
                n = Pn(e), i = D(() => {
                    const {max: $} = e;
                    return $ !== void 0 ? p.value.length >= $ : !1
                }), l = O(e.defaultFileList), d = ee(e, "fileList"), a = O(null), s = {value: !1}, u = O(!1), f = new Map,
                h = nr(d, l), p = D(() => h.value.map(Bt));
            ...
            function y($) {
                const _ = $.target;
                P(_.files ? Array.from(_.files).map(K => ({file: K, entry: null, source: "input"})) : null, $), _.value = ""
            }
            ...
            function P($, _) {
                ...
                Promise.all($.map(({file: T, entry: H}) => ln(this, void 0, void 0, function* () {
                    ...
                    return !K || (yield K({file: Y, fileList: p.value})) !== !1 ? Y : null
            ...
            function k($) {
                const {method: _, action: K, withCredentials: F, headers: M, data: C, name: T} = e,
                    H = $ !== void 0 ? p.value.filter(Y => Y.id === $) : p.value, N = $ !== void 0;
                H.forEach(Y => {
                    const {status: re} = Y;
                    (re === "pending" || re === "error" && N) && (e.customRequest ? Tp({
                        inst: {
                            ...
                            onFinish: e.onFinish,
                            onError: e.onError
                        }, file: Y, action: K, withCredentials: F, headers: M, data: C, customRequest: e.customRequest
                    }) : Mp({
                        doChange: b,
                        xhrMap: f,
                        onFinish: e.onFinish,
                    ...
                    }, T, Y, {method: _, action: K, withCredentials: F, responseType: e.responseType, headers: M, data: C}))
                })
            }

            const b = ($, _, K = {append: !1, remove: !1}) => {
                const {append: F, remove: M} = K, C = Array.from(p.value), T = C.findIndex(H => H.id === $.id);
                if (F || M || ~T) {
                    F ? C.push($) : M ? C.splice(T, 1) : C.splice(T, 1, $);
                    const {onChange: H} = e;
                    H && H({file: $, fileList: C, event: _}), w(C)
                }
            };
            ...
            return this.abstract ? c(Ve, null, (t = n.default) === null || t === void 0 ? void 0 : t.call(n), c(xl, {to: "body"}, d)) : (l == null || l(), c("div", {
    ...
    }), sn = "/web/assets/setting-c6ca7b14.svg", At = Zr("prompt-store", () => {
        const e = O([{
                type: 1,
            ...
            }, {type: 2, name: "", url: "", refer: ""}]), t = O(!1), r = O(!1), o = O([]), n = O(""), i = O(0),
            l = O({isShow: !1, newPrompt: {act: "", prompt: ""}}), d = D(() => {
                var s;
        ...
        function a(s) {
            if (s instanceof Array && s.every(u => u.act && u.prompt)) {
                if (o.value.length === 0) return o.value.push(...s), {result: !0, data: {successCount: s.length}};
                const u = s.filter(f => {
                    var h;
                    return (h = o.value) == null ? void 0 : h.every(p => f.act !== p.act && f.prompt !== p.prompt)
                });
                return o.value.push(...u), {result: !0, data: {successCount: u.length}}
            } else return {result: !1, msg: "提示词格式有误"}
        }
    ...
    }, {persist: {key: "prompt-store", storage: localStorage, paths: ["promptList"]}}), Lp = ["href"], Ep = {key: 1},
    Ap = q({
        __name: "ChatNavItem", props: {navConfig: {}}, setup(e) {
    ...
    Dp = e => new Promise((t, r) => setTimeout(t, e)), Fp = {class: "flex justify-center gap-3 px-8"},
    Np = {class: "flex justify-center items-center"}, Hp = ["src"],
    jp = be("p", {class: "text-left"}, "提示：形容词+名词+动词+风格，描述得越详细时，效果越好。", -1),
    dn = "骑着摩托的小猫咪，疾驰在路上，动漫场景，详细的细节。", Up = q({
        __name: "CreateImage", props: {show: {type: Boolean}}, emits: ["update:show"], setup(e, {emit: t}) {
            const r = e, o = $t(), n = O(""), i = O(""), l = O(!1),
                d = D({get: () => r.show, set: f => t("update:show", f)}), a = () => {
                    if (!n.value) {
                        o.error("请先输入关键词");
                        return
                    }
            ...
            return (f, h) => (te(), ke(E(ut), {
                ...
                default: X(() => [be("head", Fp, [G(E(Qe), {
                    ...
                    extra: X(() => [G(E(ce), {
                        ...
                        default: X(() => [se("使用示例创建")]),
                        _: 1
                    }), be("div", {class: "text-[#c2c2c2] px-2 xl:px-10"}, [jp, be("p", {class: "text-left"}, "示例：" + Ue(dn))])]),
                    _: 1
                }))])]), _: 1
            }, 8, ["show"]))
        }
        ...
        const e = "/sydney/ChatHub", t = O(!1), r = O(""),
            o = O([{baseUrl: "https://sydney.bing.com", label: "Bing 官方"}, {
                ...
                if (!d.baseUrl) return {isUsable: !1, errorMsg: "链接不可为空"};
                try {
                    const a = Date.now(), s = new WebSocket(d.baseUrl.replace("http", "ws") + e), u = setTimeout(() => {
                        s.close()
                    }, n);
                    ...
                    }), {isUsable: !0, delay: Date.now() - a}
                } catch (a) {
                    return {isUsable: !1, errorMsg: a instanceof Error ? a.message : ""}
                }
            };
        return {
    ...
    }, {persist: {key: "chat-store", storage: localStorage, paths: ["selectedSydneyBaseUrl", "sydneyConfigs"]}});
...
const st = {get: Wp, set: Vp};

async function Kp() {
    return fetch("/sysconf", {credentials: "include"}).then(t => t.json())
}

const qp = {getSysConfig: Kp};
var uo = (e => (e[e.OK = 200] = "OK", e[e.Unauthorized = 401] = "Unauthorized", e))(uo || {});
const Ri = Zr("user-store", () => {
        const t = "_U", r = "BingAI_Rand_IP", o = "BingAI_Auth_Key", n = O(), i = async () => {
            const v = await qp.getSysConfig();
            return v.code === uo.OK && (n.value = {...n.value, ...v.data}), v
        }, l = () => {
            const v = new Date;
            ...
            const y = await fetch("/turing/conversation/create", {credentials: "include"}).then(x => x.json()).catch(x => "error");
    ...
    }, {persist: {key: "user-store", storage: localStorage, paths: []}}),
    Gp = be("div", {class: "text-3xl py-2"}, "设置用户", -1),
    Xp = be("div", {class: "text-xl py-2"}, "将删除包括 Cookie 等的所有缓存？", -1), Yp = q({
        __name: "ChatNav", setup(e) {
            const t = O(!1), r = O(!1), o = O(""), n = $t(), i = At(), {isShowPromptSotre: l} = ot(i), d = O(!1), a = O(!1),
                s = co(), {isShowChatServiceSelectModal: u} = ot(s), f = Ri(), h = {
                    github: "github",
                    version: "version",
                ...
                }, {key: h.version, label: "版本信息"}, {key: h.chatService, label: "服务选择"}, {
                    key: h.promptStore,
                    label: "提示词库"
                }, {key: h.setToken, label: "设置用户"}, {
                    key: h.compose,
                    label: "撰写文章",
                    url: "/web/compose.html"
                }, {key: h.createImage, label: "图像创建"}, {key: h.reset, label: "一键重置"}], v = P => c(Ap, {navConfig: P}),
                y = P => {
                    var k;
                    switch (P) {
                        case h.version:
...
var vt = {FRONT: "FRONT", BEHIND: "BEHIND"}, dt = {INIT: "INIT", FIXED: "FIXED", DYNAMIC: "DYNAMIC"}, fn = 2,
    iv = function () {
        function e(t, r) {
        ...
        return Jp(e, [{
            ...
            key: "getOffset", value: function (r) {
                return (r < 1 ? 0 : this.getIndexOffset(r)) + this.param.slotHeaderSize
            }
        }, {
            key: "updateParam", value: function (r, o) {
                var n = this;
            ...
            key: "saveSize", value: function (r, o) {
            ...
            key: "handleScroll", value: function (r) {
            ...
            key: "getIndexOffset", value: function (r) {
                if (!r) return 0;
            ...
            key: "checkRange", value: function (r, o) {
                var n = this.param.keeps, i = this.param.uniqueIds.length;
                i <= n ? (r = 0, o = this.getLastIndex()) : o - r < n - 1 && (r = o - n + 1), this.range.start !== r && this.updateRange(r, o)
            }
        }, {
            key: "updateRange", value: function (r, o) {
            ...
            key: "getEndByStart", value: function (r) {
                var o = r + this.param.keeps - 1, n = Math.min(o, this.getLastIndex());
                return n
            }
        }, {
            ...
            key: "getPadBehind", value: function () {
                var r = this.range.end, o = this.getLastIndex();
        ...
        wrapClass: {type: String, default: "wrap"},
    ...
    }, sv = {event: {type: String}, uniqueKey: {type: String}, tag: {type: String}, horizontal: {type: Boolean}},
    Mi = function (t, r, o) {
        var n = null, i = D(function () {
            return t.horizontal ? "offsetWidth" : "offsetHeight"
        }), l = function () {
            return r.value ? r.value[i.value] : 0
        }, d = function () {
            var s = t.event, u = t.uniqueKey, f = t.hasInitial;
            o(s, u, l(), f)
        };
        et(function () {
        ...
        name: "VirtualListItem", props: lv, emits: ["itemResize"], setup: function (t, r) {
            var o = r.emit, n = O(null);
            return Mi(t, n, o), function () {
                var i = t.tag, l = t.component, d = t.extraProps, a = d === void 0 ? {} : d, s = t.index, u = t.source,
                    f = t.scopedSlots, h = f === void 0 ? {} : f, p = t.uniqueKey,
                    v = qt(qt({}, a), {}, {source: u, index: s});
                return G(i, {key: p, ref: n}, {
                    default: function () {
                        return [G(l, qt(qt({}, v), {}, {scopedSlots: h}), null)]
                    }
                })
            }
        }
    }), hn = q({
        name: "VirtualListSlot", props: sv, emits: ["slotResize"], setup: function (t, r) {
            var o = r.slots, n = r.emit, i = O(null);
            return Mi(t, i, n), function () {
                var l, d = t.tag, a = t.uniqueKey;
                return G(d, {ref: i, key: a}, {
                    default: function () {
...
var Oi = q({
    name: "VirtualList", props: av, setup: function (t, r) {
        var o = r.emit, n = r.slots, i = r.expose, l = t.direction === "horizontal", d = l ? "scrollLeft" : "scrollTop",
            a = O(null), s = O(), u = O(null), f;
        Te(function () {
        ...
        var h = function (C) {
            ...
            var C = t.dataKey, T = t.dataSources, H = T === void 0 ? [] : T;
            ...
            if (C >= t.dataSources.length - 1) _(); else {
                var T = f.getOffset(C);
                R(T)
            }
        }, R = function (C) {
            ...
            if (s.value) {
                var C = s.value.getBoundingClientRect(), T = s.value.ownerDocument.defaultView,
        ...
        return pn(function () {
            ...
            t.start ? m(t.start) : t.offset && R(t.offset), t.pageMode && (K(), document.addEventListener("scroll", x, {passive: !1}))
        }), _n(function () {
            ...
            var M = t.pageMode, C = t.rootTag, T = t.wrapTag, H = t.wrapClass, N = t.wrapStyle, Y = t.headerTag,
                re = t.headerClass, ve = t.headerStyle, Ce = t.footerTag, W = t.footerClass, oe = t.footerStyle,
                Q = a.value, we = Q.padFront, ye = Q.padBehind,
                ne = {padding: l ? "0px ".concat(ye, "px 0px ").concat(we, "px") : "".concat(we, "px 0px ").concat(ye, "px")},
                Le = N ? Object.assign({}, N, ne) : ne, Ne = n.header, He = n.footer;
            return G(C, {ref: s, onScroll: !M && x}, {
                default: function () {
                    return [Ne && G(hn, {
                        class: re,
                        style: ve,
                    ...
                    }), G("div", {ref: u, style: {width: l ? "0px" : "100%", height: l ? "100%" : "0px"}}, null)]
                }
            })
        }
    }
});
const cv = {class: "inline-block max-w-[120px] xl:max-w-[650px] overflow-hidden text-ellipsis"},
    uv = {class: "float-right"}, fv = q({
        __name: "ChatPromptItem", props: {index: {}, source: {}}, setup(e) {
            const t = $t(), r = At(), {promptList: o, optPromptConfig: n} = ot(r), i = d => {
                o.value = o.value.filter(a => a.act !== d.act && a.prompt !== d.prompt), t.success("删除提示词成功")
            }, l = d => {
                n.value.isShow = !0, n.value.type = "edit", n.value.title = "编辑提示词", n.value.tmpPrompt = d, n.value.newPrompt = {...d}
            };
            return (d, a) => (te(), ke(E(Si), {class: "hover:bg-gray-100 cursor-pointer p-5"}, {
                description: X(() => [G(E(er), {type: "info"}, {
                ...
                default: X(() => [G(E(hi), {tooltip: !1, "line-clamp": 2}, {
    ...
    }), hv = {class: "flex justify-start flex-wrap gap-2 px-5 pb-2"}, pv = ["href"],
    vv = {class: "flex justify-center gap-5"}, gv = ["href"], mv = q({
        __name: "ChatPromptStore", setup(e) {
            const t = $t(), r = At(), {
                ...
                if (k === "add") i.value = [m, ...i.value], t.success("添加提示词成功"); else if (k === "edit") {
                ...
                if (k.file.file) {
                    u.value = !0;
                    const m = await v(k.file.file), R = JSON.parse(m), z = r.addPrompt(R);
                ...
                f.value = !0;
                const k = JSON.stringify(i.value), b = new Blob([k], {type: "application/json"}),
                    m = URL.createObjectURL(b), R = document.createElement("a");
                ...
                k.isDownloading = !0;
                let b;
                if (k.url.endsWith(".json")) b = await fetch(k.url).then(z => z.json()); else if (k.url.endsWith(".csv")) {
                    const z = await fetch(k.url).then(A => A.text());
                    console.log(z), b = z.split(`
`).filter(A => A).map(A => {
                        var _;
                        const $ = A.split('","');
                        return {act: $[0].slice(1), prompt: (_ = $[1]) == null ? void 0 : _.slice(1)}
                    }), b.shift()
            ...
            return (k, b) => (te(), Se(Ve, null, [G(E(ut), {
                ...
                default: X(() => [be("div", hv, [G(E(Qe), {
                ...
                }, {default: X(() => [se("下载")]), _: 1}), G(E(ce), {
                    secondary: "",
                    type: "info",
                    onClick: h
                }, {default: X(() => [se("添加")]), _: 1}), G(E(Bp), {
                    ...
                    default: X(() => [G(E(ce), {
                        ...
                        type: "success",
                        loading: u.value
                    }, {default: X(() => [se("导入")]), _: 1}, 8, ["loading"])]), _: 1
                }), G(E(ce), {
                    secondary: "",
                    type: "success",
                    onClick: w,
                    loading: f.value
                }, {default: X(() => [se("导出")]), _: 1}, 8, ["loading"]), G(E(ce), {
                    secondary: "",
                    type: "error",
                    onClick: x
                }, {default: X(() => [se("清空")]), _: 1})]), E(d).length > 0 ? (te(), ke(E(Oi), {
                    key: 0,
                ...
                default: X(() => [G(E(Uh), {
                    ...
                    default: X(() => [(te(!0), Se(Ve, null, Rn(E(o), (m, R) => (te(), ke(E(Wh), {key: R}, {
                        ...
                        }, {default: X(() => [se("下载")]), _: 2}, 1032, ["onClick", "loading"])])]),
...
}`, yv = {class: "inline-block max-w-[310px] xl:max-w-[650px] overflow-hidden text-ellipsis"}, wv = q({
        __name: "ChatPromptItem", props: {index: {}, source: {}}, setup(e) {
            const t = At(), {selectedPromptIndex: r, isShowChatPrompt: o, keyword: n} = ot(t), i = l => {
                l && (n.value = "", CIB.vm.actionBar.inputText = l.prompt, CIB.vm.actionBar.input.focus(), o.value = !1)
            };
            return (l, d) => (te(), ke(E(Si), {
                class: Mn(["hover:bg-gray-100 cursor-pointer px-5 h-[130px] flex justify-start items-center", {"bg-gray-100": l.index === E(r)}]),
                ...
                default: X(() => [G(E(hi), {
                    tooltip: !1,
                    "line-clamp": 2
                }, {default: X(() => [se(Ue(l.source.prompt), 1)]), _: 1})]),
                _: 1
            }, 8, ["class"]))
        }
    }), fo = e => (Pl("data-v-4813a901"), e = e(), $l(), e), xv = {key: 0, class: "loading-spinner"},
    Cv = fo(() => be("div", {class: "bounce1"}, null, -1)), Sv = fo(() => be("div", {class: "bounce2"}, null, -1)),
    kv = fo(() => be("div", {class: "bounce3"}, null, -1)), Pv = [Cv, Sv, kv], $v = q({
        __name: "LoadingSpinner", props: {isShow: {type: Boolean}}, setup(e) {
            return (t, r) => (te(), ke(bt, {name: "fade"}, {
...
const zv = (e, t) => {
        ...
        return r
    }, Tv = zv($v, [["__scopeId", "data-v-4813a901"]]), Iv = {key: 0, class: "hidden lg:block"}, _v = {key: 1},
    Rv = {class: "hidden lg:table-cell"}, Mv = {key: 1},
    Ov = {key: 0, class: "flex justify-center items-center flex-wrap gap-2"}, Bv = ["onClick"],
    Lv = {class: "flex justify-center items-center flex-wrap gap-2"}, Ev = q({
        __name: "ChatServiceSelect", setup(e) {
            const t = co(), {isShowChatServiceSelectModal: r, sydneyConfigs: o, selectedSydneyBaseUrl: n} = ot(t), i = $t(),
                l = async s => {
            ...
            return (s, u) => (te(), ke(E(ut), {
                ...
                default: X(() => [G(E(dp), {striped: ""}, {
                    default: X(() => [be("tbody", null, [(te(!0), Se(Ve, null, Rn(E(o), (f, h) => (te(), Se("tr", {key: h}, [be("td", null, [f.isCus ? (te(), Se("span", Iv, Ue(f.label), 1)) : (te(), Se("span", _v, Ue(f.label), 1)), f.isCus ? (te(), ke(E(Qe), {
                        key: 2,
                        class: "lg:hidden",
                        value: f.baseUrl,
                    ...
                    }, {default: X(() => [se("不可用")]), _: 1})) : Je("", !0), f.delay ? (te(), ke(E(er), {
                        key: 1,
                        type: "success",
                        class: "cursor-pointer"
                    }, {
                        ...
                        secondary: "",
                        type: "success"
                    }, {default: X(() => [se("当前")]), _: 1})) : (te(), ke(E(ce), {
                        key: 1,
                        secondary: "",
                        type: "info",
                        onClick: p => d(f)
                    }, {default: X(() => [se("选择")]), _: 2}, 1032, ["onClick"]))])])]))), 128))])]), _: 1
                })]), _: 1
            }, 8, ["show"]))
        }
    }), Av = be("div", {class: "w-0 md:w-[60px]"}, null, -1),
    Dv = {key: 0, class: "fixed top-0 left-0 w-screen h-screen flex justify-center items-center bg-black/40 z-50"},
    Fv = 130, Nv = q({
        __name: "Chat", setup(e) {
            const t = $t(), r = O(!0), o = At(), {
                    isShowPromptSotre: n,
                    isShowChatPrompt: i,
                    keyword: l,
                    promptList: d,
                ...
                } = ot(o), u = co(), {isShowChatServiceSelectModal: f, sydneyConfigs: h, selectedSydneyBaseUrl: p} = ot(u),
                v = Ri(), y = O(), w = O(!1), x = O(!1), P = O(!1), k = O(""), b = O(!1),
                m = D(() => CIB.vm.isMobile && CIB.vm.sidePanel.isVisibleMobile || !CIB.vm.isMobile && CIB.vm.sidePanel.isVisibleDesktop);
            et(async () => {
                await _(), R(), SydneyFullScreenConv.initWithWaitlistUpdate({cookLoc: {}}, 10), A(), r.value = !1, K(), F()
            });
            const R = () => {
            }, z = () => {
                if (p.value) CIB.config.sydney.baseUrl = p.value, f.value = !1; else {
            ...
            return (W, oe) => (te(), Se(Ve, null, [G(Tv, {"is-show": r.value}, null, 8, ["is-show"]), be("main", null, [E(i) ? (te(), Se("div", {
                key: 0,
                ...
                footer: X(() => [G(E(Qe), {
                    ...
                    loading: b.value,
                    onClick: Ce
                }, {default: X(() => [se("授权")]), _: 1}, 8, ["loading"])]), _: 1
            })])) : Je("", !0)])], 64))
        }
    }), jv = q({
